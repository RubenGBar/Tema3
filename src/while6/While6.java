...
public class While6 {
	public static void main(String[] args) {
		...
		/*Declaro las variables donde recojo la edad de los alumnos, todas las edades sumadas, 
		 * el número de iteraciones del bucle para calcular la media de las edades y una varible 
		 * que incremento si los alumnos son mayores de edad*/
		...
		/*Creo un loop donde vuelvo a pedir la edad de los alumnos hasta que este se cumpla ^
		 * la condición y termine*/
		while (edad > 0) {
			...
			/*Incremento en 1 el valor de la variable mediaEdad para calcular la edad media de
			 *  todos los alumnos*/
			mediaEdad++;
		...
		if (mediaEdad == 0) {/*Si el valor de mediaEdad es cero imprimo por pantalla que la edad media
		 es de cero*/
		...
		/*Muestro por pantalla la suma de las edades, el número de alumnos y cuántos son
		 * mayores de edad*/
